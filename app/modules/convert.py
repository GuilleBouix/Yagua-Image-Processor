...
def _preparar_para(img: Image.Image, fmt_destino: str) -> Image.Image:
    """Convierte el modo de la imagen segÃºn lo que acepta el formato destino."""

    # Corregir rotaciÃ³n de cÃ¡mara
    ...
    if fmt_destino == 'JPEG':
        # JPEG no soporta transparencia â€” fondo blanco
    ...
    if fmt_destino == 'PNG':
        # PNG soporta todo â€” solo normalizar P con transparencia
        if img.mode == 'P':
...
def convertir_imagen(
    ...
    Returns dict con rutas, formatos y tamaÃ±os.
    """
