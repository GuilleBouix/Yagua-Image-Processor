"""
MÃ³dulo de extracciÃ³n de paleta de colores.
"""
...
def cargar_preview(ruta: str, size: tuple[int, int] = (80, 80)) -> tuple[Image.Image, int, int, str]:
    """Carga imagen, genera preview y devuelve metadata bÃ¡sica."""
...
def extraer_paleta(ruta: str, n_colores: int = 6) -> list[tuple[int, int, int]]:
    ...
    with Image.open(ruta) as img:
        ...
        # Reducir para acelerar el anÃ¡lisis
        ...
        # Ordenar Ã­ndices por frecuencia descendente
...
def exportar_paleta_imagen(
    ...
    # Intentar cargar fuente â€” si no hay, usa default
    try:
