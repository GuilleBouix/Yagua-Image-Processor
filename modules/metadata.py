"""
Módulo de metadatos EXIF.
Ver, editar, limpiar y exportar metadatos de imágenes.
"""
...
def leer_metadatos(ruta: str) -> dict[str, str]:
    ...
    Retorna dict con etiqueta legible → valor formateado.
    """
    ...
    try:
        ...
        # Mapa inverso: valor numérico → nombre de tag
...
def editar_exif(ruta_entrada: str, ruta_salida: str, campos: dict[str, str]) -> bool:
    """
    Edita campos EXIF específicos y guarda la imagen.
